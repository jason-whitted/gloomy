...
describe('PQ:Lawbringer', () => {
  ...
  it('should progress', () => {
    const result = reduce(killEnemy({ enemy: ENEMY.BANDIT_ARCHER }));
  ...
  it('should complete', () => {
    const result = reduce(
      killEnemy({ enemy: ENEMY.BANDIT_ARCHER, count: 6 }),
      killEnemy({ enemy: ENEMY.BANDIT_GUARD, count: 6 }),
      killEnemy({ enemy: ENEMY.BANDIT_COMMANDER, count: 6 }),
      killEnemy({ enemy: ENEMY.CULTIST, count: 6 }),
    );
